...
if __name__ == '__main__':
    ...
    train_dataset_transform = v2.Compose([v2.Resize(64), v2.ToTensor(),
                                          v2.Normalize(mean=[0.485, 0.456, 0.406],
                                                       std=[0.229, 0.224, 0.225])])
    val_dataset_transform = v2.Compose([v2.Resize(64), v2.ToTensor(),
                                        v2.Normalize(mean=[0.485, 0.456, 0.406],
                                                     std=[0.229, 0.224, 0.225])])
    test_dataset_transform = v2.Compose([v2.Resize(64), v2.ToTensor(),
                                         v2.Normalize(mean=[0.485, 0.456, 0.406],
                                                      std=[0.229, 0.224, 0.225])])
