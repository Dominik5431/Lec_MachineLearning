...
test = {}
## Load the data
train.update({'data': np.loadtxt(dir + '/lc_train_data.dat')})
train.update({'label': np.loadtxt(dir + '/lc_train_label.dat')})
test.update({'data': np.loadtxt(dir + '/lc_test_data.dat')})
test.update({'label': np.loadtxt(dir + '/lc_test_label.dat')})
